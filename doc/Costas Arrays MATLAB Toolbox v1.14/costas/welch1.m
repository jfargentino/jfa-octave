function out = welch1(p,a,c)
%welch1(p,a,c) generates all W1 Welch array sequences

%	Generates all W1 Welch Costas array sequences from a prime p,
%   with optional primitive elements a (1 = all), optional circular shift c.
%	If c is not specified then all circular shifts are generated. 
%   Arrays begin with 1.
%
%	Examples
%   --------
