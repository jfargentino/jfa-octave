function out = testlempel2
%testlempel2 determines if lempel2.m is working correctly

%	Tests the lempel2 generation function by comparing the arrays which it
...
i=1;
for p=test_range
    generated=minimal(lempel2(p));
    loaded=load(['c' sprintf('%.2d',p-2) '_L2uni.out']);
