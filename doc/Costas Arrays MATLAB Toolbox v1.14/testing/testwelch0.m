function out = testwelch0
%testwelch0 determines if welch0.m is working correctly

%	Tests the welch0 generation function by comparing the arrays which it
...
i=1;
for p=test_range
    generated=dsyms(welch0(p));
    loaded=load(['c' sprintf('%.2d',p) '_W0all.out']);
